...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // edit_ads
        if (0 === strpos($pathinfo, '/edit-ads') && preg_match('#^/edit\\-ads/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
            if (substr($pathinfo, -1) !== '/') {
        ...
        // delete_ads
        if (0 === strpos($pathinfo, '/delete-ads') && preg_match('#^/delete\\-ads/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
            if (substr($pathinfo, -1) !== '/') {
        ...
        // renew_ads
        if (0 === strpos($pathinfo, '/renew-ads') && preg_match('#^/renew\\-ads/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
            if (substr($pathinfo, -1) !== '/') {
        ...
        // new_ads_product
        if (0 === strpos($pathinfo, '/new-ads-product') && preg_match('#^/new\\-ads\\-product/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
            if (substr($pathinfo, -1) !== '/') {
        ...
        // edit_product_ads
        if (0 === strpos($pathinfo, '/edit-product-ads') && preg_match('#^/edit\\-product\\-ads/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
            if (substr($pathinfo, -1) !== '/') {
        ...
        // delete_product_ads
        if (0 === strpos($pathinfo, '/delete-product-ads') && preg_match('#^/delete\\-product\\-ads/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
            if (substr($pathinfo, -1) !== '/') {
        ...
        // _security_logout
        if ($pathinfo === '/logout') {
            return array (  '_controller' => 'SeekerPlus\\UserBundle\\Controller\\DefaultController::logoutAction',  '_route' => '_security_logout',);
        }
