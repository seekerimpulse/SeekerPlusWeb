...
<div id="mainlogin">
	<div id="Jkcontent-login">
			...
			<jdoc:include type="message" />
				...
				<h1>Bienvenido a la administración de SeekerPlus!</h1>
					<div id="lock"></div>
	...
	<div id="Jkfooter-login">
		<p class="copyright">
			<a href="#" target="_blank" title="J">SEEKERPLUS!</a> es un proyecto de software Libre © 2015 SeekerImpulse S.A.S 
		</p>
		<p>
		<p>
	</div>
	<div class="login-img-back">
		<span class="login-img-text">SeekerImpulse S.A.S</span>
