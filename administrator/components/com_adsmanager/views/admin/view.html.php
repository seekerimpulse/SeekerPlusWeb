...
class AdsmanagerViewAdmin extends TView
{
	...
	function _listcontents()
	{
		...
		$content_ad_headline	  = $app->getUserStateFromRequest( 'com_adsmanager.content.content_ad_headline','content_ad_headline', '','word' );
		...
		if ($content_ad_headline != "") {
			$filters['content_ad_headline'] = $content_ad_headline;
		}
		...
		$this->assignRef('content_ad_headline',$content_ad_headline);
