...
<table>
				<tr>
					...
					<td nowrap="nowrap">
						...
						<span>
						<input style="width:10rem" type="text" name="search" value="<?php echo htmlspecialchars( $this->search );?>" class="text_area" onChange="document.adminForm.submit();" />
						</span>
						<span>
						<?php echo JText::_('Id')?>:
						</span>
						<span>
						<input style="width:5rem" type="text" name="content_id" value="<?php echo htmlspecialchars( $this->content_id );?>" class="text_area" onChange="document.adminForm.submit();" />
						</span>
						<span>
						<?php echo JText::_('ADSMANAGER_TH_TITLE')?>:
						</span>
						<span>
						<input type="text" name="content_ad_headline" value="<?php echo htmlspecialchars( $this->content_ad_headline );?>" class="text_area" onChange="document.adminForm.submit();" />
						</span>
...
<?php
	...
	foreach($content->images as $img) {
		echo "<img width='50' height='50' src='".JURI::root()."images/com_adsmanager/ads/".$img->image."?time=".time()."'>";
		echo '&nbsp;';  
	}
	?>
	</td>
